<?php 
	 ...
	 * 试卷类
	 */
	class Examination extends Validate{

		//验证规则
		protected $rule = [

			//试卷名称
			"name" => "require|length:1,30|special:[~!@#$%^&*<>]",
			//考试时间
			"strat" => "require|date|dateFormat:Y-m-d H:i:s",
			//考试时长
			"length" => "require|number|between:1,2000",
			//拖堂时长
			"delay" => "require|number|between:0,30",
			//搜索
			"search" => "require|length:1,30|special:[~!@#$%^&*<>]",
		...
		protected $message = [
			...
			"delay.require" => "拖堂时长不能为空",
			"delay.number" => "拖堂时长为数值",
			"delay.between" => "拖堂时长不能大于30分钟",
			"search.require" => "搜索不能为空",
			"search.length" => "搜索长度为1-30位",
			"search.special" => "搜索不能包含特殊字符",
