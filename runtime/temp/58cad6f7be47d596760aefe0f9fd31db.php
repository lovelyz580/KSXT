<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\ksxt1\public/../application/index\view\course\see.html";i:1516188394;s:80:"D:\phpStudy\WWW\ksxt1\public/../application/index\view\teacher\alterDetails.html";i:1516180014;}*/ ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="panel text-left right">
				<div class="panel-heading">
					<ul class="list-unstyled list-inline">
						...
						<li class="pull-right">
							<button class="addCourse">新增</button>
						</li>
					</ul>
				</div>
				<div class="panel-body">
					<?php if(is_array($dataC) || $dataC instanceof \think\Collection || $dataC instanceof \think\Paginator): $i = 0; $__LIST__ = $dataC;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
