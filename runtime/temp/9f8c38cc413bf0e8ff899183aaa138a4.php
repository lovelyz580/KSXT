<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"E:\phpstudy\PHPTutorial\WWW\ksxt\public/../application/index\view\student\alterDetails.html";i:1516265980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-xs-7">
                    <form class="form-horizontal" id="form">
                        <div class="form-group">
                            <label class="col-lg-3 col-md-3 col-sm-4 control-label">学号：</label>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 col-md-3 col-sm-4 control-label">班级：</label>
                            <div class="col-lg-8 col-md-8 col-sm-7">
