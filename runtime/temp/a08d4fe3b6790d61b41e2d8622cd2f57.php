<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpStudy\WWW\ksxt1\public/../application/index\view\examination\alter.html";i:1516159133;s:80:"D:\phpStudy\WWW\ksxt1\public/../application/index\view\teacher\alterDetails.html";i:1516180014;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<title>试卷-修改</title>
	<link rel="stylesheet" type="text/css" href="__STATIC__/css/examination/alter.css">
	<script type="text/javascript" src="__STATIC__/js/examination/alter.js"></script>
				...
				<div class="panel-heading">
					<ul class="list-unstyled list-inline">
						...
						<li id="patterns" class="pull-right">
							<a href="<?php echo url('index/Examination/addPage',['idPascal'=>$idpascal]); ?>">添加试题</a>
						</li>
						<li class="pull-right"><button>移出</button></li>
					</ul>
				</div>
				<div class="panel-body">
					<table class="table-responsive table">
						...
						<tbody>
							...
							<tr>
								<td>
									<input type="checkbox" value="<?php echo $value['tid']; ?>">
								</td>
								<td><?php echo $k; ?></td>
								...
								<td>
									...
									<button value="<?php echo $value['tid']; ?>">移出</button>
								</td>
							</tr>
