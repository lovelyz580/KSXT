<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpStudy\WWW\ksxt\public/../application/index\view\student\hasKsxt.html";i:1517132627;s:79:"D:\phpStudy\WWW\ksxt\public/../application/index\view\student\alterDetails.html";i:1516265978;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="panel-body">
                    <table class="table-responsive table text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="<?php echo url('index/Examination/showDetails',['id'=>$value['id']]); ?>" class="a" value="<?php echo $value['status']; ?>}"><?php echo $value['name']; ?></a></td>
                                <td><?php echo $value['cname']; ?></td>
                                <td><?php echo $value['strat']; ?></td>
                                <td><?php echo $value['score']; ?>分</td>
                                <td class="badge" style="background-color: red;"><?php echo $value['status']; ?></td>
                            </tr>
